...
if (isset($_POST['submit'])) {
    ...
    $email = $_POST['email'];
    $phone = $_POST['phone'];
    $query = "INSERT INTO wgain(name, email, phone) VALUE('$name','$email','$phone')";
...
<div>
    <table>
        <tr>
            <td><img src="images\class\wg1.png" alt="gain"/></td>
            <td><img src="images\class\wg2.jpg" alt="gain"/></td>
        </tr>
        <tr>
            <td><img src="images\class\wg3.jpg" alt="gain"/></td>
            <td><img src="images\class\wg4.jpg" alt="gain"/></td>
        </tr>
    </table>
