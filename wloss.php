...
if (isset($_POST['submit'])) {
    ...
    $email = $_POST['email'];
    $phone = $_POST['phone'];
    $query = "INSERT INTO wloss(name, email, phone) VALUE('$name','$email','$phone')";
...
<div>
    <table>
        <tr>
            <td><img src="images\class\wl1.jpg" alt="gain"/></td>
            <td><img src="images\class\wl2.jpg" alt="gain"/></td>
        </tr>
        <tr>
            <td><img src="images\class\wl3.jpg" alt="gain"/></td>
            <td><img src="images\class\wl4.jpg" alt="gain"/></td>
        </tr>
    </table>
